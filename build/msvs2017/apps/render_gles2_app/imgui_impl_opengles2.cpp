...
void ImGui_ImplOpenGLES2_Shutdown()
{
	ImGui_ImplOpenGLES2_DestroyDeviceObjects();
}

// ImGui_ImplOpenGLES2_RenderDrawData
...
bool ImGui_ImplOpenGLES2_CreateFontsTexture()
{
	// Build texture atlas
	ImGuiIO& io = ImGui::GetIO();
...
// ImGui_ImplOpenGLES2_CreateDeviceObjects
bool ImGui_ImplOpenGLES2_CreateDeviceObjects()
{
	// Backup GL state
