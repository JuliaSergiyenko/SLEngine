...
void main()
{
	...
	// find position
	gl_Position = uProjMat * vec4(aPosition, 1.0);
}
...
bool ImGui_ImplOpenGLES3_Init()
{
	ImGui_ImplOpenGLES3_CreateDeviceObjects();
	return true;
}

// ImGui_ImplOpenGLES3_Shutdown
void ImGui_ImplOpenGLES3_Shutdown()
{
	ImGui_ImplOpenGLES3_DestroyDeviceObjects();
}

// ImGui_ImplOpenGLES3_RenderDrawData
void ImGui_ImplOpenGLES3_RenderDrawData(ImDrawData* draw_data)
{
...
// ImGui_ImplOpenGLES3_CreateFontsTexture
bool ImGui_ImplOpenGLES3_CreateFontsTexture()
{
	// Build texture atlas
	ImGuiIO& io = ImGui::GetIO();
...
// ImGui_ImplOpenGLES3_DestroyFontsTexture
void ImGui_ImplOpenGLES3_DestroyFontsTexture()
{
	if (g_FontTexture)
	{
		ImGuiIO& io = ImGui::GetIO();
...
// ImGui_ImplOpenGLES3_CreateDeviceObjects
bool ImGui_ImplOpenGLES3_CreateDeviceObjects()
{
	// Backup GL state
...
// ImGui_ImplOpenGLES3_DestroyDeviceObjects
void ImGui_ImplOpenGLES3_DestroyDeviceObjects()
{
