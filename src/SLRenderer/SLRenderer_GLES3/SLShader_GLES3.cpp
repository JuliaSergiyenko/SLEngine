...
namespace SLR_GLES3
{
	...
	// create CreateShader
	bool SLShader_GLES3::CreateShader(const char* vertexSource, const char* fragmentSource)
	{
	...
	void SLShader_GLES3::DeleteShader()
	{
	...
	// shader statuc check
	bool SLShader_GLES3::ShaderStatusCheck(GLuint shader)
	{
		GLint isCompiled = 0;
	...
	// ProgramStatusCheck
	bool SLShader_GLES3::ProgramStatusCheck(GLuint program)
	{
		GLint isLinked = 0;
