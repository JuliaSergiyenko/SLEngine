...
namespace SLR_GL4
{
	...
	// UpdateFormats
	void SLTexture2D_GL4::UpdateFormats(SLTextureDataType textureDataType)
	{
	...
	// UpdateImage
	void SLTexture2D_GL4::UpdateImage(int32_t mipLevel, SLTextureDataType textureDataType, uint32_t width, uint32_t height, const void* data, size_t dataSize)
	{
