...
namespace SLR_GL4
{
	...
	// create CreateShader
	bool SLShader_GL4::CreateShader(const char* vertexSource, const char* fragmentSource)
	{
	...
	void SLShader_GL4::DeleteShader()
	{
	...
	// shader statuc check
	bool SLShader_GL4::ShaderStatusCheck(GLuint shader)
	{
		GLint isCompiled = 0;
	...
	// ProgramStatusCheck
	bool SLShader_GL4::ProgramStatusCheck(GLuint program)
	{
		GLint isLinked = 0;
