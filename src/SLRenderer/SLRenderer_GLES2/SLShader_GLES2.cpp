...
namespace SLR_GLES2
{
	...
	// create CreateShader
	bool SLShader_GLES2::CreateShader(const char* vertexSource, const char* fragmentSource)
	{
	...
	void SLShader_GLES2::DeleteShader()
	{
	...
	// shader statuc check
	bool SLShader_GLES2::ShaderStatusCheck(GLuint shader)
	{
		GLint isCompiled = 0;
	...
	// ProgramStatusCheck
	bool SLShader_GLES2::ProgramStatusCheck(GLuint program)
	{
		GLint isLinked = 0;
